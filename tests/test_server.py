...
def test_initialize_and_tools_list():
    ...
    assert {tool["name"] for tool in listed["result"]["tools"]} == {
        "ui.inspect_application", "ui.inspect_accessibility_tree", "ui.inspect_named_control", "ui.inspect_automation_control", "ui.capture_screen", "scene.read_visible_state", "scene.read_manager", "scene.list_items", "workflow.catalog", "workflow.stop_all"
    }
